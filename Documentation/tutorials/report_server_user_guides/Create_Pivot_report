...
Creating a Pivot report in ReportServer begins with configuring a basic Dynamic List report - https://akvo-reporting/Documentation/tutorials/report_server_user_guides/Create_Dynamic_list_report.md
